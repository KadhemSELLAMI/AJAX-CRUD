$(document).ready(function(){
    ...
    $(document).on('click', '.update-product-button', function(){
        ...
        $.getJSON("http://localhost/www/AJAX%20CRUD/api/product/read_one.php?id=" + id, function(data){
            ...
            $.getJSON("http://localhost/www/AJAX%20CRUD/api/category/read.php", function(data){
            
                // build 'categories option' html
                // loop through returned list of data
                var categories_options_html=`<select name='cate_id' class='form-control'>`;
                ...
                var update_product_html=`
                    ...
                    <form id='update-product-form' action='#' method='post' border='0'>
                        <table class='table table-hover table-responsive table-bordered'>
                            ...
                            <tr>
                                <td>Description</td>
                                <td><textarea name='desc' class='form-control' required>` + description + `</textarea></td>
                            </tr>
    ...
    $(document).on('submit', '#update-product-form', function(){
        ...
        $.ajax({
            url: "http://localhost/www/AJAX%20CRUD/api/product/update.php?id=",
            type : "POST",
